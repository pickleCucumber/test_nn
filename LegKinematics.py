...
class LegIK():
    def __init__(self,
                 ...
                 leg_lim=[-0.1, 2.59]):
        """Параметры геометрии ноги:
        hip_length — плечо смещения бедра от корпуса,
        shoulder_length — длина бедра,
        leg_length — длина голени.
        Все значения в метрах и должны отражать реальные размеры робота.
        """
