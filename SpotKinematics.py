...
class SpotModel:
    def __init__(self,
        ...
        Параметры звеньев (в метрах):
        - hip_length: половина расстояния от центра корпуса до оси первого шарнира (плечо).
        - shoulder_length: длина верхнего звена (бедро) от плеча до колена.
        - leg_length: длина нижнего звена (голень) от колена до лапы.
        """
        # Leg Parameters
